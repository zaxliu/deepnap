...
########################################
# Index log files for DynaQtable agents
# Author: Jingchu Liu
# Date: Feb 2017
#######################################
...
if len(argv)>3:
    ...
    num_sim = int(argv[2])
    num = int(argv[3])
    n_process = int(argv[4]) if len(argv)>4 else 1
    ...
    print "Please specify pattern of log file name, num of simulated data, and num of files."
